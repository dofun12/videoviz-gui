...
@Component({
  selector: 'app-busca-avancada-novo',
  templateUrl: './busca-avancada-novo.component.html',
  styleUrls: ['./busca-avancada-novo.component.scss']
})
export class BuscaAvancadaNovoComponent implements OnInit {
